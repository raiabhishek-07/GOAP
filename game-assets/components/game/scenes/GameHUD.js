...
export class GameHUD extends (Phaser ? Phaser.Scene : Object) {
    ...
    openMap() {
        ...
        // Get player data for map
        const playerData = gameScene ? {
            x: gameScene.player ? gameScene.player.x : 0,
            y: gameScene.player ? gameScene.player.y : 0,
            health: gameScene.player ? gameScene.player.playerData.health : 100
        } : { x: 0, y: 0, health: 100 };
