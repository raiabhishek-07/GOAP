...
if (isVisible) {
const gameScene = this.scene.get('OpenWorldScene');
const playerData = gameScene && gameScene.player ? {
x: gameScene.player.x || 0,
y: gameScene.player.y || 0,
health: gameScene.player.playerData ? gameScene.player.playerData.health : 100
} : { x: 0, y: 0, health: 100 };
this._updateFullMap(playerData.x, playerData.y);
}
return;
}
